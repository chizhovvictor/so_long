...
/*
	1 создаем функцию чек мап где проверяем чтоб длины строк в массиве были олинаковыми
	2 проверяем первую и последную строку на 1
	3 поверяем другие строки на наличие 1 в начале и конце
*/
